...
const I18N = {
  en: {
    ...
    events:{agaman:'Ganpati Bappa Agaman',shlok:'Ganesh Shlok, Poem, Short Speech',pakKala:'Pak Kala Competition',bhajan:'MiCasaa Bhajan Mandal',foodStall:'Food Stall',shriramBhajan:'Shriram-Janaki Mahila Bhajni Mandal',talentSenior:'MiCasaa Got Talent — Seniors (11 onwards)',drawing:'Drawing Competition',talentJunior:'MiCasaa Got Talent — Juniors (Age 3 to 10)',sports:'Sports Day',mahaprasad:'Mahaprasad',rangoli:'Rangoli Competition',satyanarayan:'Satyanarayana Pooja',musicalChairs:'Musical Chairs',prize:'Prize Distribution',visarjan:'Ganpati Bappa Visarjan'},
    details:{talent:'Dance, Drama, Skit, Singing, Music, Other',sports:'Cricket, Football, Sack Race, Lemon Spoon Race'},
    comps:{shlok:'Ganesh Shlok / Poem / Short Speech',pakKala:'Pak Kala Competition',foodStall:'Food Stall',talentSenior:'MiCasaa Got Talent — Seniors (11 onwards)',drawing:'Drawing Competition',talentJunior:'MiCasaa Got Talent — Juniors (Age 3 to 10)',cricket:'Sports Day — Cricket',football:'Sports Day — Football',sackRace:'Sports Day — Sack Race',lemonSpoon:'Sports Day — Lemon Spoon Race',rangoli:'Rangoli Competition',musicalChairs:'Musical Chairs'}
  },
  hi: {
...
const competitions = [
  ...
  {id:'talentSenior', icon:'🎤', name:'MiCasaa Got Talent — Seniors (11 onwards)', date:'18 Sept', time:'8 PM onwards', type:'talent'},
