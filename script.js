...
const I18N = {
  en: {
    ...
    events:{agaman:'Ganpati Bappa Agaman',shlok:'Ganesh Shlok, Poem, Short Speech',pakKala:'Pak Kala Competition',bhajan:'MiCasaa Bhajan Mandal',foodStall:'Food Stall',shriramBhajan:'Shriram-Janaki Mahila Bhajni Mandal',talentSenior:'MiCasaa Got Talent — Seniors (Age 11 & above)',drawing:'Drawing Competition',talentJunior:'MiCasaa Got Talent — Juniors (Age 3 to 10)',sports:'Sports Day',mahaprasad:'Mahaprasad',rangoli:'Rangoli Competition',satyanarayan:'Satyanarayana Pooja',musicalChairs:'Musical Chairs',prize:'Prize Distribution',visarjan:'Ganpati Bappa Visarjan'},
    details:{talent:'Dance, Drama, Skit, Singing, Music, Other',sports:'Cricket, Football, Sack Race, Lemon Spoon Race'},
    comps:{shlok:'Ganesh Shlok / Poem / Short Speech',pakKala:'Pak Kala Competition',foodStall:'Food Stall',talentSenior:'MiCasaa Got Talent — Seniors (Age 11 & above)',drawing:'Drawing Competition',talentJunior:'MiCasaa Got Talent — Juniors (Age 3 to 10)',cricket:'Sports Day — Cricket',football:'Sports Day — Football',sackRace:'Sports Day — Sack Race',lemonSpoon:'Sports Day — Lemon Spoon Race',rangoli:'Rangoli Competition',musicalChairs:'Musical Chairs'}
  },
  hi: {
    ...
    events:{agaman:'गणपति बप्पा आगमन',shlok:'गणेश श्लोक, कविता, लघु भाषण',pakKala:'पाक कला प्रतियोगिता',bhajan:'MiCasaa भजन मंडल',foodStall:'फूड स्टॉल',shriramBhajan:'श्रीराम-जानकी महिला भजनी मंडल',talentSenior:'MiCasaa Got Talent — सीनियर (आयु 11+)',drawing:'चित्रकला प्रतियोगिता',talentJunior:'MiCasaa Got Talent — जूनियर (आयु 3 से 10)',sports:'खेल दिवस',mahaprasad:'महाप्रसाद',rangoli:'रंगोली प्रतियोगिता',satyanarayan:'सत्यनारायण पूजा',musicalChairs:'म्यूज़िकल चेयर्स',prize:'पुरस्कार वितरण',visarjan:'गणपति बप्पा विसर्जन'},
    details:{talent:'नृत्य, नाटक, स्किट, गायन, संगीत, अन्य',sports:'क्रिकेट, फुटबॉल, बोरा दौड़, नींबू-चम्मच दौड़'},
    comps:{shlok:'गणेश श्लोक / कविता / लघु भाषण',pakKala:'पाक कला प्रतियोगिता',foodStall:'फूड स्टॉल',talentSenior:'MiCasaa Got Talent — सीनियर (आयु 11+)',drawing:'चित्रकला प्रतियोगिता',talentJunior:'MiCasaa Got Talent — जूनियर (आयु 3 से 10)',cricket:'खेल दिवस — क्रिकेट',football:'खेल दिवस — फुटबॉल',sackRace:'खेल दिवस — बोरा दौड़',lemonSpoon:'खेल दिवस — नींबू-चम्मच दौड़',rangoli:'रंगोली प्रतियोगिता',musicalChairs:'म्यूज़िकल चेयर्स'}
  },
  mr: {
    ...
    events:{agaman:'गणपती बाप्पा आगमन',shlok:'गणेश श्लोक, कविता, छोटेखानी भाषण',pakKala:'पाककला स्पर्धा',bhajan:'MiCasaa भजन मंडळ',foodStall:'फूड स्टॉल',shriramBhajan:'श्रीराम-जानकी महिला भजनी मंडळ',talentSenior:'MiCasaa Got Talent — सीनियर (वय 11+)',drawing:'चित्रकला स्पर्धा',talentJunior:'MiCasaa Got Talent — ज्युनियर (वय 3 ते 10)',sports:'क्रीडा दिवस',mahaprasad:'महाप्रसाद',rangoli:'रांगोळी स्पर्धा',satyanarayan:'सत्यनारायण पूजा',musicalChairs:'म्युझिकल चेअर्स',prize:'बक्षीस वितरण',visarjan:'गणपती बाप्पा विसर्जन'},
    details:{talent:'नृत्य, नाटक, स्किट, गायन, संगीत, इतर',sports:'क्रिकेट, फुटबॉल, गोणी शर्यत, लिंबू-चमचा शर्यत'},
    comps:{shlok:'गणेश श्लोक / कविता / छोटेखानी भाषण',pakKala:'पाककला स्पर्धा',foodStall:'फूड स्टॉल',talentSenior:'MiCasaa Got Talent — सीनियर (वय 11+)',drawing:'चित्रकला स्पर्धा',talentJunior:'MiCasaa Got Talent — ज्युनियर (वय 3 ते 10)',cricket:'क्रीडा दिवस — क्रिकेट',football:'क्रीडा दिवस — फुटबॉल',sackRace:'क्रीडा दिवस — गोणी शर्यत',lemonSpoon:'क्रीडा दिवस — लिंबू-चमचा शर्यत',rangoli:'रांगोळी स्पर्धा',musicalChairs:'म्युझिकल चेअर्स'}
  }
};
...
const competitions = [
  ...
  {id:'talentSenior', icon:'🎤', name:'MiCasaa Got Talent — Seniors (Age 11 & above)', date:'18 Sept', time:'8 PM onwards', type:'talent'},
  {id:'drawing', icon:'🎨', name:'Drawing Competition', date:'19 Sept', time:'1 PM onwards'},
  {id:'talentJunior', icon:'🎭', name:'MiCasaa Got Talent — Juniors (Age 3 to 10)', date:'19 Sept', time:'8 PM onwards', type:'talent'},
