...
const fullSchedule = [
  {date:'14 Sept', dayIndex:1, events:[{icon:'🙏', key:'agaman', time:'12 PM onwards'},{icon:'📖', key:'shlok', time:'8 PM onwards', register:true}]},
  {date:'15 Sept', dayIndex:2, events:[{icon:'🎵', key:'bhajan', time:'3–5 PM'},{icon:'👨‍🍳', key:'pakKala', time:'6–7 PM', register:true}]},
  {date:'16 Sept', dayIndex:3, events:[{icon:'🎶', key:'shriramBhajan', time:'5–7 PM'},{icon:'🪑', key:'musicalChairs', time:'8 PM onwards', register:true}]},
  ...
  {date:'19 Sept', dayIndex:6, events:[{icon:'🏃', key:'sackRace', time:'9–11 AM', register:true},{icon:'🥄', key:'lemonSpoon', time:'9–11 AM', register:true},{icon:'🎨', key:'drawing', time:'1 PM onwards', register:true},{icon:'🎭', key:'talentJunior', time:'8 PM onwards', detailsKey:'talent', register:true},{icon:'👵', key:'seniorCitizen', time:'9 PM'}]},
  {date:'20 Sept', dayIndex:0, events:[{icon:'🏏', key:'sports', time:'8–11 AM', detailsKey:'sports', register:true},{icon:'🍲', key:'mahaprasad', time:'7 PM onwards'}]},
  ...
  {date:'23 Sept', dayIndex:3, events:[{icon:'🍱', key:'bhog56', time:'7:30 PM'}]},
  {date:'24 Sept', dayIndex:4, events:[{icon:'🏆', key:'prize', time:'8 PM onwards'}]},
  {date:'25 Sept', dayIndex:5, events:[{icon:'🌺', key:'visarjan', time:'5:30 PM onwards'}]}
];

const competitions = [
  {id:'shlok', icon:'📖', name:'Ganesh Shlok / Poem / Short Speech', date:'14 Sept', time:'8 PM onwards', type:'speech'},
  {id:'pakKala', icon:'👨‍🍳', name:'Pak Kala Competition', date:'15 Sept', time:'6–7 PM'},
  {id:'musicalChairs', icon:'🪑', name:'Musical Chairs', date:'16 Sept', time:'8 PM onwards'},
  {id:'foodStall', icon:'🍽️', name:'Food Stall', date:'17 Sept', time:'8 PM onwards', type:'foodstall'},
  {id:'talentSenior', icon:'🎤', name:'MiCasaa Got Talent — Senior Kids (Age 11 & above)', date:'18 Sept', time:'8 PM onwards', type:'talent'},
  {id:'sackRace', icon:'🏃', name:'Sack Race', date:'19 Sept', time:'9–11 AM', type:'sport'},
  {id:'lemonSpoon', icon:'🥄', name:'Lemon Spoon Race', date:'19 Sept', time:'9–11 AM', type:'sport'},
  {id:'drawing', icon:'🎨', name:'Drawing Competition', date:'19 Sept', time:'1 PM onwards'},
  {id:'talentJunior', icon:'🎭', name:'MiCasaa Got Talent — Junior Kids (Age below 11)', date:'19 Sept', time:'8 PM onwards', type:'talent'},
  {id:'cricket', icon:'🏏', name:'Sports Day — Cricket', date:'20 Sept', time:'8–11 AM', type:'sport'},
  {id:'football', icon:'⚽', name:'Sports Day — Football', date:'20 Sept', time:'8–11 AM', type:'sport'},
...
function syncAgeGroupFromAge(){
  if(!ageInput || !ageGroupInput) return '';
  const group=ageGroupForAge(ageInput.value);
  // Age group is intentionally system-derived and locked. A manually selected or
  // previously saved mismatched value can never override the age entered.
  ageGroupInput.value=group;
  ageGroupInput.disabled=true;
  ageGroupInput.setAttribute('aria-disabled','true');
  ageGroupInput.tabIndex=-1;
  return group;
}
if(ageInput && ageGroupInput){
  ageInput.addEventListener('input', syncAgeGroupFromAge);
  ageInput.addEventListener('change', syncAgeGroupFromAge);
  syncAgeGroupFromAge();
}
